"""Service helpers for persisting job search history."""
...
async def list_job_search_history(
    ...
    """Return newest job search history rows first."""
    stmt = (
...
async def count_job_search_history(session: AsyncSession) -> int:
    """Return total number of saved job search history rows."""
